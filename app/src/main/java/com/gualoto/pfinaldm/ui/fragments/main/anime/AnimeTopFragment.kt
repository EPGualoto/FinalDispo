...
import com.gualoto.pfinaldm.databinding.FragmentAnimeTopBinding
...
class AnimeTopFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentAnimeTopBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val data: TopAnimeUI? = jsonString?.let {
            Gson().fromJson(it, TopAnimeUI::class.java)
        }
